...
data_source_tab <- tabItem(
  ...
  box(width = 12, height = '700px',
      ...
      h5("Attraction"),
      p("Artworks ", a("https://data.melbourne.vic.gov.au/explore/dataset/outdoor-artworks/map/?location=13,-37.80614,144.94913&basemap=mbs-7a7333")),
      p("Places of Interest ", a("https://data.melbourne.vic.gov.au/explore/dataset/landmarks-and-places-of-interest-including-schools-theatres-health-services-spor/table/")),
      p("Fountain, Art, Monument ", a("https://data.melbourne.vic.gov.au/explore/dataset/public-artworks-fountains-and-monuments/table/")),
      p("Memorials and Sculptures ", a("https://data.melbourne.vic.gov.au/explore/dataset/public-memorials-and-sculptures/table/")),
      p("Plaques ", a("https://data.melbourne.vic.gov.au/explore/dataset/plaques-located-at-the-shrine-of-remembrance/information/")),
      p("Music Venues ", a("https://data.melbourne.vic.gov.au/explore/dataset/live-music-venues/table/?location=16,-37.81041,144.96043&basemap=mbs-7a7333")),
      p("Drinking fountains  ", a("https://data.melbourne.vic.gov.au/explore/dataset/drinking-fountains/table/?location=16,-37.79872,144.9433&basemap=mbs-7a7333")),
      p("Public toilets ", a("https://data.melbourne.vic.gov.au/explore/dataset/public-toilets/table/")),
